...
function Section1() {
  const items = [
    { title: "Smartphone and Iphone Repair", img: "/smartphone.webp" },
    { title: "Screen Replacement", img: "/screen.webp" },
    { title: "Laptop Repair", img: "/2.webp" },
    { title: "Windows Installation", img: "/install.webp" },
  ];
          ...
          >
            {[...items, ...items].map((item, i) => (
              ...
              >
                <img
                  src={item.img}
                  srcSet={`${item.img}?w=200&q=60 200w, ${item.img}?w=300&q=65 300w, ${item.img}?w=500&q=70 500w`}
